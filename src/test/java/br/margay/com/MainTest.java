...
//    SICOOB
    ...
    public void requestEfiPixGet() {
        ...
        c.setBase(configPix.getPspPix().getHomologacao());
...
//                .send();
    ...
    @Test
    public void processCertificadoTest() throws Exception {
        ...
        System.out.println(storePix.getCertificate());
        System.out.println(storePix.getPassword());

        Consumer c = Consumer.getInstance(storePix);

        c.setBase(pspPix.getHomologacao());
    ...
    @Test
    public void configuracaoSplitPixEfi() throws Exception {
