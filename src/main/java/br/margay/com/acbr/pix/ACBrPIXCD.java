package br.margay.com.acbr.pix;
...
public final class ACBrPIXCD extends ACBrLibBase {
    ...
    private interface ACBrPIXCDLib extends Library {
        ...
        ACBrPIXCDLib INSTANCE = LibraryLoader.getInstance();
        ...
        class LibraryLoader {
            ...
            public static ACBrPIXCDLib getInstance() {
                if (instance == null) {
                    instance = (ACBrPIXCDLib) Native.synchronizedLibrary(Native.load(JNA_LIBRARY_NAME, ACBrPIXCDLib.class));
                }
