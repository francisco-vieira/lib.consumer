package br.margay.com.acbr.mail;

import br.margay.com.acbr.ACBrLibBase;
import br.margay.com.acbr.enums.ACBrSessao;
import br.margay.com.acbr.enums.MailAttachmentDisposition;
import br.margay.com.acbr.interf.ACBrMailLib;
...
public final class ACBrMail extends ACBrLibBase {
    ...
    private ACBrMail() throws Exception {
        Path path = Paths.get("ACBrLib1.ini");
        ...
        int ret = ACBrMailLib.INSTANCE.MAIL_Inicializar(handle, toUTF8(path.toFile().getAbsolutePath()), toUTF8("9ce31390f109c8a8dae503ae0b3c3804fbd4fcf6"));
        checkResult(ret);
